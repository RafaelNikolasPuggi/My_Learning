...
import GerarRelatorioJSON from "./GeraRelatorio";
...
const geradorDeRelatorios = new GerarRelatorioJSON(quadroColaboradores.colaboradores, calculaSalario);
...
console.log(geradorDeRelatorios.gerarEmJSON());
console.log(' ')
